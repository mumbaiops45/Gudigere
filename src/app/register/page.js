...
export default function RegisterPage() {
  ...
  /* password strength — only project colours */
    ...
    <div className="min-h-[calc(100vh-64px)] flex">
      ...
      >
        ...
        <div className="absolute -top-20 -right-20 w-80 h-80 rounded-full"
          style={{ background: "radial-gradient(circle, rgba(245,158,11,.3), transparent)" }} />
        <div className="absolute -bottom-16 -left-16 w-60 h-60 rounded-full"
          style={{ background: "radial-gradient(circle, rgba(219,39,119,.3), transparent)" }} />
            ...
            {[
              ...
              <li key={perk} className="flex items-center gap-3 text-white/80 text-sm">
                <span className="shrink-0 w-5 h-5 rounded-full flex items-center justify-center"
                  ...
                  <svg width="10" height="10" fill="none" stroke="var(--dark)" strokeWidth="2.5" viewBox="0 0 24 24">
        ...
        {/* Already a member */}
        <div className="relative z-10 p-5 rounded-2xl flex items-center justify-between"
