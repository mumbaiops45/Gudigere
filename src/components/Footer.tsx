...
export default function Footer() {
    return (
        <footer className="bg-[#0c0c17] text-white mt-10 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-6">
                    ...
                    <div className="sm:col-span-2 md:col-span-1 space-y-3 sm:space-y-4">
                        ...
                        <p className="text-pink-400 text-[8px] sm:text-[10px] uppercase tracking-[3px] sm:tracking-[4px] font-bold">
                            India&apos;s #1 Toy Marketplace
                        </p>
                        ...
                        <div className="space-y-2 pt-1">
                            {contactItems.map(({ Icon, text }) => (
                                ...
                                >
                                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:bg-pink-600/20 group-hover:border-pink-500/30 transition-all duration-200">
                                        <Icon size={12} className="text-pink-400 sm:w-3.5 sm:h-3.5" />
                                    </div>
                        ...
                        <div className="flex flex-wrap gap-1.5 sm:gap-2 pt-1">
                            {socialLinks.map(({ Icon, href, label, color }) => (
                                <a
                                    ...
                                    rel="noopener noreferrer"
                                    aria-label={label}
                                    className={`w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 transition-all duration-200 hover:text-white hover:scale-110 hover:-translate-y-0.5 hover:border-transparent ${color}`}
                                >
                    ...
                    {/* ─── SHOP BY CATEGORY ─── */}
                    <div>
                        <h3 className="text-[10px] sm:text-xs font-black uppercase tracking-widest mb-3 sm:mb-4 flex items-center gap-2">
                            <span className="w-1 h-2.5 sm:h-3.5 bg-gradient-to-b from-pink-500 to-purple-500 rounded-full" />
                            Shop
                        </h3>
                        <ul className="space-y-1.5 sm:space-y-2">
                            {shopLinks.map((link) => (
                                <li key={link.name}>
                                    <Link
                                        href={link.href}
                                        className="text-xs sm:text-sm text-gray-400 hover:text-pink-400 transition-colors flex items-center gap-0 hover:gap-1.5 group"
                                    >
                                        <span className="w-0 group-hover:w-2 h-px bg-pink-500 rounded transition-all duration-200 overflow-hidden shrink-0" />
                                        {link.name}
                                    </Link>
            ...
            {/* ─── BOTTOM BAR ─── */}
            <div className="border-t border-white/10 bg-black/30">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex flex-col md:flex-row items-center justify-between gap-2 text-center md:text-left">

                    <p className="text-[10px] sm:text-xs text-gray-500 order-2 md:order-1">
                        &copy; 2026{" "}
                        <span className="text-pink-500 font-semibold">GoodieGear</span> Pvt.
                        Ltd. All rights reserved. 🇮🇳
                    </p>

                    <p className="text-[10px] sm:text-xs text-gray-500 order-1 md:order-2">
                        Designed &amp; Developed by{" "}
                        <a
                            href="https://www.nakshatranamahacreations.com/"
                            target="_blank"
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 flex-wrap justify-center order-3">
                        <Link
                            href="/privacy-policy"
                            className="text-[10px] sm:text-xs text-gray-500 hover:text-pink-400 transition"
                        >
                            Privacy Policy
                        </Link>
                        <Link
