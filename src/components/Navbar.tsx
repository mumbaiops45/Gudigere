...
//         <div className="bg-white shadow-[0_1px_0_rgba(0,0,0,.08)]">
//           <div className="max-w-7xl mx-auto px-3 sm:px-5 lg:px-8 h-14 sm:h-16 flex items-center gap-3 sm:gap-4">
...
//               <span className="text-xl sm:text-2xl lg:text-3xl font-black text-pink-600 leading-none">Goodie</span>
//               <span className="text-xl sm:text-2xl lg:text-3xl font-black text-slate-900 leading-none"> Gear</span>
//             </button>
...
//             <div className="hidden lg:flex relative flex-1 h-11 rounded-xl overflow-hidden border-2 border-slate-200 hover:border-pink-400 focus-within:border-pink-600 focus-within:shadow-[0_0_0_3px_rgba(219,39,119,.12)] transition-all bg-white">
//               {/* <div className="hidden md:flex flex-1 h-11 rounded-xl overflow-hidden border-2 border-slate-200 hover:border-pink-400 focus-within:border-pink-600 focus-within:shadow-[0_0_0_3px_rgba(219,39,119,.12)] transition-all bg-white"> */}
//               <input
//                 type="text"
//                 value={searchQuery}
...
//                 }}
//                 placeholder="Search toys, brands, age groups..."
//                 className="flex-1 min-w-0 px-4 pr-12 text-sm text-slate-700 placeholder:text-slate-400 outline-none bg-white"
//               />
...
//               <button onClick={() => setSearchOpen(v => !v)} className="lg:hidden p-2 rounded-lg hover:bg-pink-50 hover:text-pink-600 transition-colors">
//                 <Search size={20} className="text-slate-700" />
//               </button>
//               {user ? (
...
//                       <div className="px-3 py-3 bg-pink-50 border-b border-pink-100">
...
//                 </div>
//               </button>
//               <button onClick={() => router.push("/cart")} className="relative flex items-center gap-2 ml-2 px-3 sm:px-5 py-2.5 bg-pink-600 hover:bg-pink-700 transition-colors text-white rounded-xl shadow-[0_4px_14px_rgba(219,39,119,.35)] hover:shadow-[0_6px_20px_rgba(219,39,119,.45)]">
//                 <div className="relative">
//                   <ShoppingCart size={18} className="sm:w-[19px] sm:h-[19px]" />
...
//           </div>
//           {searchOpen && (
//             <div className="lg:hidden px-4 pb-3 border-t border-slate-100">
//               <div className="flex h-11 mt-2.5 rounded-xl overflow-hidden border-2 border-pink-500 shadow-sm">
...
//         <nav className="hidden lg:block bg-slate-900 shadow-md border-b border-slate-800">
//           <div className="max-w-7xl mx-auto h-12 flex items-center no-scrollbar gap-1 px-4">
...
//           <div className="absolute left-0 top-0 bottom-0 w-[85vw] max-w-[340px] bg-white shadow-2xl flex flex-col overflow-hidden">
//             {/* Drawer header */}
//             <div className="bg-slate-900 px-5 py-4 flex items-center justify-between shrink-0">
//               <div className="flex items-center gap-3">
...
//               <div className="grid grid grid-cols-2 gap-2 sm:gap-3 gap-2">
//                 {categories.map((cat: Category) => (
//                   <button
//                     key={cat._id}
...
//                       />
//                     ) : (
//                       <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg bg-pink-100 flex items-center justify-center text-lg">🧸</div>
//                     )}
//                     <span className="text-[11px] sm:text-xs font-medium text-slate-700 group-hover:text-pink-700 line-clamp-2 leading-tight">{cat.name}</span>
//                   </button>
//                 ))}
//               </div>
//             </div>
  ...
  return (
    <>
      <header className="w-full sticky top-0 z-50 flex flex-col">
            ...
            <div className="hidden lg:flex relative flex-1 h-11 rounded-xl overflow-hidden border-2 border-slate-200 hover:border-pink-400 focus-within:border-pink-600 focus-within:shadow-[0_0_0_3px_rgba(219,39,119,.12)] transition-all bg-white">
              ...
              {searchQuery && (
                <button
                  ...
                  className="absolute right-14 top-1/2 -translate-y-1/2 z-10 p-1 rounded-full hover:bg-gray-100 transition-colors"
                >
                  <X size={16} className="text-gray-500" />
                </button>
              )}
        ...
        <nav className="hidden lg:block bg-slate-900 shadow-md border-b border-slate-800">
          <div className="max-w-7xl mx-auto h-12 flex items-center no-scrollbar gap-1 px-4 overflow-x-auto">
            <button
              onClick={() => setDrawerOpen(true)}
              className="shrink-0 flex items-center gap-2 px-4 py-1.5 rounded-full bg-pink-600 hover:bg-pink-700 transition-all text-white font-semibold text-sm shadow-md"
            >
      ...
      {drawerOpen && (
        <div className="fixed inset-0 z-[100] lg:hidden">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-[85vw] max-w-[340px] bg-white shadow-2xl flex flex-col overflow-hidden">
            ...
            {/* Categories grid – FIXED duplicate classes */}
            <div className="flex-1 overflow-y-auto p-4">
              <p className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-3">Shop By Category</p>
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/50">
          <div className="w-full max-w-sm rounded-xl bg-white p-6 shadow-2xl">
            ...
            <p className="mt-3 text-sm text-gray-600">Are you sure you want to logout?</p>
            <div className="mt-6 flex justify-end gap-3">
              <button onClick={cancelLogout} className="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium hover:bg-gray-100">No</button>
              <button onClick={confirmLogout} className="rounded-lg bg-rose-600 px-4 py-2 text-sm font-medium text-white hover:bg-rose-700">Yes</button>
            </div>
          </div>
        </div>
      )}
